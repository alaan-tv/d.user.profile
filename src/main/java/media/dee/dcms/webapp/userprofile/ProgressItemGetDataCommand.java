...
@Component
@WebComponent.Command.For(value="getData", component=ProfileProgresstem.class)
public class ProgressItemGetDataCommand implements WebComponent.Command {
    ...
    public JsonValue execute(JsonValue... command) {
        ...
        URL dataURL = bundle.getResource(String.format("/data/progress/%s.json", ((JsonObject)command[0]).getInt("instanceID")));
        if( dataURL == null ){
